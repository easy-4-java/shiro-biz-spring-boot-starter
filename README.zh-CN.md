...
| JDK | `17` |
| 坐标 | `io.github.easy4j:shiro-biz-spring-boot-starter:1.1.3.RELEASE` |
| 配置前缀 | `shiro.biz` |
...
| `DefaultAdvisorAutoProxyCreator` Bean | ✅ 稳定 | 通过 ShiroBizAnnotationProcessorAutoConfiguration, ShiroBizWebAutoConfiguration, ShiroEndpointAutoConfiguration 自动注册 |
