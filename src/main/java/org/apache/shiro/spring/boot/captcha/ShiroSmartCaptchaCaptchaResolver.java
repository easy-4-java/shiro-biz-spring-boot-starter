...
/**
 * A {@link CaptchaResolver} that validates captchas generated by the SmartCaptcha library.
 * <p>Requires the smartcaptcha-spring-boot-starter dependency on the classpath at runtime.</p>
 *
...
public class ShiroSmartCaptchaCaptchaResolver implements CaptchaResolver {
	...
	public boolean validCaptcha(ServletRequest request, CaptchaAuthenticationToken token)
		...
		try {
			String captcha = (String) WebUtils.toHttp(request).getSession().getAttribute(CAPTCHA_ATTRIBUTE);
			if(captcha == null) {
