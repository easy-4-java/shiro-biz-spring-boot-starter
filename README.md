...
> **Current Version**：`1.1.3.RELEASE`<br>
> **JDK Baseline**：`17`<br>
...
| JDK | `17` |
| Coordinates | `io.github.easy4j:shiro-biz-spring-boot-starter:1.1.3.RELEASE` |
...
| `DefaultAdvisorAutoProxyCreator` bean | ✅ Stable | Auto-registered via ShiroBizAnnotationProcessorAutoConfiguration, ShiroBizWebAutoConfiguration, ShiroEndpointAutoConfiguration |
